...
import org.apache.jena.graph.RecordingGraphListener;
...
@Contract(DatasetGraph.class)
public class DatasetGraphContractTest<T extends DatasetGraph>
{
	 private static final Logger LOG = LoggerFactory
				.getLogger(DatasetGraphContractTest.class);
    ...
    @ContractTest public void create_1()
    {
        DatasetGraph dsg = producer.newInstance() ;
        assertNotNull(dsg) ;
     ...
     */
    @ContractTest public void quad_01()
    {
        DatasetGraph dsg = producer.newInstance() ;
        assertNotNull(dsg) ;
    ...
    @ContractTest public void quad_02()
    {
        DatasetGraph dsg = producer.newInstance() ;
        assertNotNull(dsg) ;
        Quad quad = SSE.parseQuad("(quad <g> <s> <p> <o>)") ;
    ...
    @ContractTest public void quad_03()
    {
        DatasetGraph dsg = producer.newInstance() ;
        assertNotNull(dsg) ;
    ...
    @ContractTest public void quad_04()
    {
        DatasetGraph dsg = producer.newInstance() ;
        assertNotNull(dsg) ;
        Quad quad1 = SSE.parseQuad("(quad <g> <s> <p> <o1>)") ;
    ...
    @ContractTest public void quad_05()
    {
        DatasetGraph dsg = producer.newInstance() ;
        assertNotNull(dsg) ;
        Quad quad1 = SSE.parseQuad("(quad <g> <s> <p> <o1>)") ;
    ...
    @ContractTest public void graph_00()
    {
        DatasetGraph dsg = producer.newInstance() ;
        assertNotNull(dsg) ;
    ...
    // Graph centric operations
    @ContractTest public void graph_01()
    {
        DatasetGraph dsg = producer.newInstance() ;
        assertNotNull(dsg) ;
    ...
    @ContractTest public void graph_02()
    {
        Node g = NodeFactory.createURI("g") ;
        DatasetGraph dsg = producer.newInstance() ;
        assertNotNull(dsg) ;
    ...
    @ContractTest public void graph_03()
    {
        Node g = NodeFactory.createURI("g") ;
        DatasetGraph dsg = producer.newInstance() ;
    ...
    @ContractTest public void find_01()
    {
    ...
    @ContractTest public void deleteAny_01()
    {
        DatasetGraph dsg = producer.newInstance() ;
    ...
    @ContractTest public void deleteAny_02()
    {
        DatasetGraph dsg = producer.newInstance() ;
        Node subject = NodeFactory.createURI("http://example/s");
        Node predicate = NodeFactory.createURI("http://example/p");
    ...
    @ContractTest public void clear_01() {
        DatasetGraph dsg = producer.newInstance() ;
        Quad quad = SSE.parseQuad("(quad <g> <s> <p> <o>)") ;
